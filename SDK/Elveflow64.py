...
from ctypes import *
ElveflowDLL=CDLL('C:/LabPrograms/Python/ElveflowScopeFoundry/SDK/DLL64/Elveflow64.dll')# change this path 
...
def OB1_Reset_Digit_Sens (OB1_ID, Channel_1_to_4):
 ...
 #
def M_S_R_D_Initialization (Device_Name, Sens_Ch_1, Sens_Ch_2, Sens_Ch_3, Sens_Ch_4, MSRD_ID_out):
	X_M_S_R_D_Initialization=ElveflowDLL.M_S_R_D_Initialization
	X_M_S_R_D_Initialization.argtypes=[c_char_p, c_uint16, c_uint16, c_uint16, c_uint16, POINTER(c_int32)]
	return X_M_S_R_D_Initialization (Device_Name, Sens_Ch_1, Sens_Ch_2, Sens_Ch_3, Sens_Ch_4, MSRD_ID_out)
...
def M_S_R_D_Add_Sens (M_S_R_D_ID, Channel_1_to_4, SensorType, DigitalAnalog, FSens_Digit_Calib, FSens_Digit_Resolution):
	...
	X_M_S_R_D_Add_Sens.argtypes=[c_int32, c_int32, c_uint16, c_uint16, c_uint16, ]
...
def M_S_R_D_Destructor (M_S_R_D_ID):
 ...
 # and the return value will be zero
 #
def M_S_R_D_Get_Sens_Data (Channel_1_to_4, M_S_R_D_ID, Sens_Data):
	...
	return X_M_S_R_D_Get_Sens_Data (Channel_1_to_4, M_S_R_D_ID, Sens_Data)
